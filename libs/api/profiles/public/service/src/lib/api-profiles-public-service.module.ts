...
import {AddTicketUpvotedHandler,CreateUserHandler,DeleteUserHandler,UpdateUserEmailHandler,UpdateUserHandler,UpdateUserNameHandler,UpdateUserPasswordHandler,VerifyUserPasswordHandler,UpdateUserRatingHandler,ResetUserRatingHandler, IncUserRatingHandler, DecUserRatingHandler} from './commands/api-profiles-public-command-handler.handler'
...
@Module({
  ...
  providers: [ApiProfilesPublicService,
              ...
              IncUserRatingHandler,
              DecUserRatingHandler,
